<form class="contato position-relative" class="py-5" id="formcontato" method="post">
    ...
    <p class="m-0 cor-c1"> <small> <em> * preenchimento de campo <span class="cor-c2">obrigatório</span> </em> </small> </p>
    <a href="javascript:void(0);" onclick="reloadcaptcha_contato();" class="small cor-c1"><i class="fas fa-redo mr-1"></i> Trocar imagem</a>
    <div class="form-row">
        <div class="d-flex flex-wrap flex-grow-1 contato-borda">
            <div class="captcha"><img id="imgcaptcha-contato" src="captcha-contato.php" class="d-block" style="border-radius:30px 30px 4px 30px;"></div>
            <!-- <i class="contato-icone fas fa-pencil-alt"></i> -->
    ...
    <div>
        <button type="submit" class="bt bt-b1v mt-2">Enviar mensagem <i class="fas fa-paper-plane border-left border-light ml-1 pl-1"></i></button>
        <button type="reset" class="bt bt-b1v mt-2">Cancelar mensagem <i class="fas fa-eraser border-left border-light ml-1 pl-1"></i></button>
    </div>

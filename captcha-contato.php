<?php 
	...
	function captcha($largura,$altura,$tamanho_fonte,$quantidade_letras){
		...
		$fundo = imagecolorallocate($imagem,43, 49, 56); // definindo a cor do fundo da imagem em formato rgb
		$letras = imagecolorallocate($imagem,235, 177, 17); // definindo a cor do texto da imagem em formato rgb
